...
const ESTILOS_GLOBALES = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .nav-btn:hover { color: var(--crema); background: rgba(255,255,255,0.06); }
  .nav-btn.activo { color: var(--dorado); font-weight: 500; }
  ...
  .nav-pill:hover { background: var(--dorado-suave); transform: translateY(-1px); }
  ...
  .status-dot--ok .status-dot__indicador { background: #4caf79; box-shadow: 0 0 6px #4caf7966; }
  .status-dot--error .status-dot__indicador { background: #e05252; }
  ...
  .dato-fila__clave { color: var(--gris-arena); }
  .dato-fila__valor { font-weight: 500; color: var(--tinta-suave); }
  ...
  .mapa-turistico__btn-refetch:hover { background: var(--crema-oscura); color: var(--tinta); }
  .mapa-turistico__btn-refetch:disabled { opacity: 0.4; cursor: not-allowed; }
  .mapa-turistico__btn-refetch:not(:disabled):active { transform: rotate(180deg); }
  ...
  .popup-nilo .leaflet-popup-content { margin: 0; width: auto !important; }
  .popup-nilo .leaflet-popup-tip-container { display: none; }
  ...
  .popup-nilo__rating { font-size: 0.75rem; color: var(--dorado); }
  .popup-nilo__rating em { font-style: normal; margin-left: 4px; color: var(--gris-arena); }
  ...
  .app-footer a { color: var(--tierra-claro); text-decoration: none; }
  ...
  @keyframes pulso-origen {
    0%, 100% { box-shadow: 0 2px 8px rgba(200,131,10,0.55); transform: scale(1); }
    50%       { box-shadow: 0 2px 20px rgba(200,131,10,0.8); transform: scale(1.12); }
  }
  @keyframes entrar {
    from { opacity: 0; transform: translateY(12px); }
    to   { opacity: 1; transform: translateY(0); }
  }
  .app-main { animation: entrar 0.45s ease both; }
`
...
export default function App() {
  ...
  // Coordenadas fijas de Nilo, Cundinamarca
  const LON = -74.634
  const LAT  = 4.305
    ...
    <div className="app">
      ...
      <header className="app-header" role="banner">
        <div className="app-header__inner">
          ...
          <nav className="app-header__nav" aria-label="Navegación principal">
            <button className="nav-btn activo">Mapa</button>
            <button className="nav-btn">Atractivos</button>
            <button className="nav-btn">Rutas</button>
            <button className="nav-btn">Prestadores</button>
      ...
      <main className="app-main" role="main">
        ...
        <aside className="panel-lateral" aria-label="Información del municipio">
          ...
          <div className="carta">
            ...
            <div className="dato-fila">
              <span className="dato-fila__clave">Coordenadas</span>
              <span className="dato-fila__valor">{LAT}°N, {Math.abs(LON)}°O</span>
            </div>
          </div>
          ...
          <div className="carta">
            ...
            <div className="control-radio">
              <label htmlFor="slider-radio">
                Radio de búsqueda alrededor del municipio
              </label>
              <input
                id="slider-radio"
                type="range"
      ...
      <footer className="app-footer" role="contentinfo">
        <p>
          ...
          Datos © <a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noopener">OpenStreetMap</a>{' '}
